<?php
/*
Plugin Name: Campaign Monitor Dual Registration (OLD)
Description: Caution, the plugin repository has been renamed. You need to de-install this plugin, remove the files and install the plugin 'campaign-monitor-dual-registration'. This version will no longer be updated.
Version: 1.0.5
